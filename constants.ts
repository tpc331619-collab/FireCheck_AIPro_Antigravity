...
export const EQUIPMENT_HIERARCHY: Record<string, string[]> = {
  '滅火設備': [
    '乾粉滅火器', '二氧化碳滅火器', '機械泡沫滅火器', '強化液滅火器', '潔淨滅火器', '海龍滅火器',
    '水霧滅火設備', '簡易自動滅火設備', '室內消防栓', '室外消防栓箱', '室外單口消防栓',
    '室外雙口消防栓', '室外地上消防栓', '室外地下消防栓', '泡沫滅火設備', '二氧化碳滅火設備',
    '乾粉滅火設備', '鹵化烴滅火設備', '惰性氣體滅火設備'
  ],
  '撒水設備': [
    '密閉式自動撒水設備', '開放式自動撒水設備', '濕式自動撒水設備', '乾式自動撒水設備',
    '預動式自動撒水設備', '水道連結型自動撒水設備', '放水型自動撒水設備', '細水霧滅火設備', '消防管壓力錶'
  ],
  '警報設備': [
    '火警自動警報設備', '手動報警設備', '緊急廣播設備(主機)', '緊急廣播設備(副機)', '119 火災通報裝置'
  ],
  '標示設備': [
    '出口標示燈', '避難方向指示燈', '避難指標'
  ],
  '照明設備': [
    '壁掛', '吸頂式', '崁頂式 (嵌入式)', '手提', '便攜式'
  ],
  '避難設備': [
    '緩降機', '避難梯', '救助袋', '避難繩索', '滑台', '避難橋', '滑桿'
  ],
  '排煙系統': [
    '自然排煙', '機械排煙'
  ],
