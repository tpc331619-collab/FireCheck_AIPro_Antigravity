        ...
        <div className="px-10 pb-12">
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={loading}
              className="w-full relative flex items-center justify-center gap-3 py-4 px-4 bg-white/10 hover:bg-white/20 border border-white/10 rounded-lg text-white font-bold transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:scale-[1.01] active:scale-[0.98] disabled:opacity-50 disabled:scale-100 group/btn"
            >
              {loading ? (
                <div className="w-5 h-5 border-2 border-slate-300 border-t-red-600 rounded-full animate-spin" />
              ) : (
                <>
                  <div className="flex items-center justify-center w-6 h-6 bg-white rounded-full p-1 mr-2">
                  ...
                  <ChevronRight className="w-4 h-4 ml-auto opacity-0 -translate-x-2 group-hover/btn:opacity-50 group-hover/btn:translate-x-0 transition-all text-slate-400" />
                </>
              )}
            </button>
